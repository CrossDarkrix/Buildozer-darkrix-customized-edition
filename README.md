...
- Install buildozer:
      ...
      # latest dev version
      # if you use a virtualenv, don't use the `--user` option
      pip install --user https://github.com/CrossDarkrix/Buildozer-darkrix-customized-edition/archive/master.zip

      # git clone, for working on buildozer
      git clone https://github.com/CrossDarkrix/Buildozer-darkrix-customized-edition
      cd buildozer
